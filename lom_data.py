...
NORTH = Heading(name='north', cardinal=True, bearing=0, offset=(-1,0), 
    view_offsets=[
        ...
        [(435, 470), (-6, -1), 0.1], # Left arc
        [(363, 470), (-6, -2), 0.1],
        [(246, 470), (-5, -3), 0.1],
        [(170, 470), (-5, -4), 0.1],
        [(89, 470), (-4, -5), 0.1],
        [(28, 470), (-3, -5), 0.1],
        [(589, 470), (-6, 1), 0.1], # Right arc
        [(661, 470), (-6, 2), 0.1],
        [(778, 470), (-5, 3), 0.1],
        [(854, 470), (-5, 4), 0.1],
        [(935, 470), (-4, 5), 0.1],
        [(996, 470), (-3, 5), 0.1],
        #
        [(512, 474), (-5, 0), 0.12], # Centre
        [(415, 474), (-5, -1), 0.12], # Left arc
        [(340, 474), (-5, -2), 0.12],
        [(190, 474), (-4, -3), 0.12],
        [(128, 474), (-5, -4), 0.12],
        [(70, 474), (-4, -5), 0.12],
        #[(609, 474), (-5, 1), 0.12], # Right arc
        #[(674, 474), (-5, 2), 0.12],
        #[(834, 474), (-4, 3), 0.12],
        #[(896, 474), (-4, 4), 0.12],
        #[(954, 474), (-4, 5), 0.12],
        #
        #[(512, 480), (-4, 0), 0.15], # Centre
        #[(395, 480), (-4, -1), 0.15], # Left arc
        #[(305, 480), (-4, -2), 0.15],
        #
